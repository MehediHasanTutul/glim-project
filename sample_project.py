...
path = f'https://github.com/MehediHasanTutul/glim-project/blob/Boss/{modelname}'
...
file_name = 'https://github.com/MehediHasanTutul/glim-project/blob/Boss/sample_input.csv'
