...
path = f'D:/OneDrive - Deakin University/abbas web app project/glim_app/models/{modelname}'
...
file_name = 'D:/OneDrive - Deakin University/abbas web app project/glim_app/data/sample_input.csv'
