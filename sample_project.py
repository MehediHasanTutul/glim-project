...
path = f'https://raw.githubusercontent.com/MehediHasanTutul/glim-project/blob/Boss/{modelname}'
...
file_name = 'https://raw.githubusercontent.com/MehediHasanTutul/glim-project/blob/Boss/sample_input.csv'
