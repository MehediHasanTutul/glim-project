...
col2.markdown("<h4 style='text-align: center; color: black;'>An intelligent online platform to predict adverse outcomes from cancer-related malnutrition using the GLIM criteria</h4>", unsafe_allow_html=True)
